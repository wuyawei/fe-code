...
## 预告
   ...
   如果你对原型和原型链已经很熟悉了，也可以直接跳过这部分，直接看<a href="#2">实践</a>
## 思维导图
...
### 小结
   1. 原型链，其中又包括`prototype`、`constructor`、`__proto__`这几个知识点，比如原型的继承、`__proto__`的原理、 constructor 的指向这些都是面试题中的熟面孔。
   2. new 命令所做的几件事、new 实例化的对象具有的特点以及模拟实现 new 命令的函数。
## <a name="2">实践</a>
